package com.berrontech.erp.commons.util.http;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.berrontech.erp.commons.context.ContentType;
...
public abstract class AbstractHttpApi {
    ...
    public <T> List<T> getForArray(String url, Class<T> itemClass) {
        final String response = get(url);
        return JSONObject.parseArray(response, itemClass);
    }
